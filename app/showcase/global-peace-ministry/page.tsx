  ...
  return (
    <section ref={containerRef} className="h-screen w-full relative overflow-hidden flex items-center">
      ...
      <div ref={imageWrapperRef} className="absolute inset-0 z-20 overflow-hidden pointer-events-none">
        ...
        <img
          src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1400&h=900&fit=crop&q=80"
          alt="Hero Project"
      ...
      <div ref={textRef} className="w-full md:w-1/2 px-8 md:px-20 z-10 relative">
        ...
        <RevealLine delay={0.1}>
          <h1 className="text-[clamp(3rem,6vw,7rem)] font-black uppercase tracking-tighter leading-[0.9]">
            Global<br /><span className="font-satoshi italic font-normal text-white/50">Peace Ministry</span>
          </h1>
        </RevealLine>
          ...
          <div className="grid grid-cols-2 gap-8 max-w-xs">
            <div>
              ...
              <RevealLine delay={0.5}>
                <span className="text-sm uppercase font-bold tracking-widest text-white">Global Peace Ministry</span>
              </RevealLine>
            </div>
            <div>
              ...
              <RevealLine delay={0.55}>
                <span className="text-sm uppercase font-bold tracking-widest text-white">Nonprofit</span>
              </RevealLine>
            </div>
          </div>
        </div>
...
function DescriptionSection() {
  ...
  const text = "Designed and developed a modern nonprofit website for Global Peace Ministry, focused on spreading peace, community empowerment, and spiritual values through an engaging and user-friendly digital experience.";

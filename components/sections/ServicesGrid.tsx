...
const SERVICES = [
  {
    ...
    line: "Your logo looks like you paid $5 on Fiverr. Let's fix that. We build brand identities that walk into the room and immediately disrespect everyone else's. Strategy first, aesthetics second, total market domination always. Logo, typography, voice — crafted to make your competitors sweat.",
  ...
  },
  {
    ...
    tag: "Content & Growth",
    line: "You've been 'posting consistently' for 8 months and your best reel got 67 views. We get it. Platform-aware, audience-first content that actually earns attention — not just a calendar someone fills to feel productive. Reels, carousels, captions — all with a plan that makes sense.",
  ...
  },
  {
    ...
    tag: "Web & Dev",
    line: "Your website is either your best salesperson or an expensive PDF nobody reads. We design and build websites that look premium AND convert — because aesthetics without function is just art school. Fast, mobile-first, SEO-ready, and built to actually make your phone ring.",
  ...
  },
  {
    ...
    tag: "Paid Media",
    line: "We turned ₹2 lakhs into ₹20 lakhs for one client. Yes, we're going to keep saying that until you call us. Meta and Google campaigns built on real outcomes — sales, leads, bookings. Every rupee tracked. Every ad tested. No vanity metrics, no 'brand awareness' smoke screens.",
  ...
  },
  {
    ...
    title: "UI/UX Design",
    tag: "Product Design",
    line: "If your app needs an onboarding tutorial to explain itself, the design failed — not the user. We build interfaces that feel like they were designed by someone who's actually used software before. Research-backed, user-tested, friction-free, and built for humans not robots.",
  ...
  },
  {
    ...
    title: "SEO",
    tag: "Organic Growth",
    line: "Page 2 of Google is a cemetery. Nobody goes there. Let's fix that before your competition gets comfortable on Page 1. Technical SEO, on-page optimisation, content strategy, and link building — done properly, not as an afterthought. Long-term growth that compounds while you sleep.",
